...
$sql = "SELECT cr.*, u.name AS client_name FROM client_requests cr JOIN users u ON cr.client_id = u.id WHERE (cr.service_type = 'LabTesting' OR cr.service_type = '')";
if ($hasNurseCol) {
...
<head>
<meta charset="utf-8">
<title>Lab Testing Jobs - Nurses</title>
...
<body>
<div class="container">
  <h2>Available Lab Testing Requests</h2>
  <button onclick="window.history.back()" class="back-btn">Back</button>

  <?php if(count($requests)===0): ?>
    <div class="card">No lab testing requests available.</div>
  <?php else: foreach($requests as $r): ?>
    <div class="card">
      ...
      <div style="margin-top:8px">
        <strong>Requested Tests:</strong> <?php echo $items_display; ?>
      </div>
      <?php endif; ?>
