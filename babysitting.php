...
$sql = "SELECT cr.*, u.name AS client_name FROM client_requests cr JOIN users u ON cr.client_id = u.id WHERE cr.service_type = 'Babysitting'";
if ($hasNurseCol) {
...
<head>
<meta charset="utf-8">
<title>Babysitting Jobs - Nurses</title>
...
<body>
<div class="container">
  <h2>Available Babysitting Requests</h2>
  <button onclick="window.history.back()" class="back-btn">Back</button>

  <?php if(count($requests)===0): ?>
    <div class="card">No babysitting requests available.</div>
